(function(g){var window=this;'use strict';var DKa=function(a,b){return g.Lb(a,b)},EKa=function(a){if(a instanceof g.Yi)return a;
...
return c}throw Error("Not implemented");},FKa=function(a,b,c){if(g.La(a))try{g.zb(a,b,c)}catch(d){if(d!==g.Gn)throw d;
}else{a=EKa(a);try{for(;;)b.call(c,a.next(),void 0,a)}catch(d){if(d!==g.Gn)throw d;}}},b5=function(a,b,c){a.l.set(b,c)},c5=function(a){b5(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^g.Sa()).toString(36));
return a},d5=function(a,b,c){Array.isArray(c)||(c=[String(c)]);
g.$m(a.l,b,c)},GKa=function(a,b){var c=[];
FKa(b,function(d){try{var e=g.Wn.prototype.l.call(this,d,!0)}catch(f){if("Storage: Invalid value was encountered"==f)return;throw f;}void 0===e?c.push(d):g.Vn(e)&&c.push(d)},a);
return c},HKa=function(a,b){b=GKa(a,b);
g.zb(b,function(c){g.Wn.prototype.remove.call(this,c)},a)},IKa=function(a){if(a.V){if(a.V.locationOverrideToken)return{locationOverrideToken:a.V.locationOverrideToken};
if(null!=a.V.latitudeE7&&null!=a.V.longitudeE7)return{latitudeE7:a.V.latitudeE7,longitudeE7:a.V.longitudeE7}}return null},JKa=function(a,b){g.fb(a,b)||a.push(b)},e5=function(a){var b=0,c;
...
if(/^\s*$/.test(a)?0:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/(?:"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)[\s\u2028\u2029]*(?=:|,|]|}|$)/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,"")))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);},MKa=function(a){if(a.zg&&"function"==typeof a.zg)return a.zg();
...
else if(g.La(a)||"string"===typeof a)g.zb(a,b,void 0);else{if(a.Ch&&"function"==typeof a.Ch)var c=a.Ch();else if(a.zg&&"function"==typeof a.zg)c=void 0;else if(g.La(a)||"string"===typeof a){c=[];for(var d=a.length,e=0;e<d;e++)c.push(e)}else c=g.Jb(a);d=MKa(a);e=d.length;for(var f=0;f<e;f++)b.call(void 0,d[f],c&&c[f],a)}},OKa=function(a,b,c,d){var e=new g.Om(null,void 0);
...
this.type="REMOTE_CONTROL";this.obfuscatedGaiaId=this.avatar=this.username="";this.capabilities=new Set;this.experiments=new Set;this.theme="u";new g.Lm;a&&(this.id=a.id||a.name,this.name=a.name,this.app=a.app,this.type=a.type||"REMOTE_CONTROL",this.username=a.user||"",this.avatar=a.userAvatarUri||"",this.obfuscatedGaiaId=a.obfuscatedGaiaId||"",this.theme=a.theme||"u",PKa(this,a.capabilities||""),QKa(this,a.experiments||""))},PKa=function(a,b){a.capabilities.clear();
g.Je(b.split(","),g.Pa(DKa,RKa)).forEach(function(c){a.capabilities.add(c)})},QKa=function(a,b){a.experiments.clear();
b.split(",").forEach(function(c){a.experiments.add(c)})},i5=function(a){a=a||{};
this.name=a.name||"";this.id=a.id||a.screenId||"";this.token=a.token||a.loungeToken||"";this.uuid=a.uuid||a.dialId||"";this.idType=a.screenIdType||"normal"},j5=function(a,b){return!!b&&(a.id==b||a.uuid==b)},SKa=function(a){return{name:a.name,
screenId:a.id,loungeToken:a.token,dialId:a.uuid,screenIdType:a.idType}},TKa=function(a){return new i5(a)},UKa=function(a){return Array.isArray(a)?g.Mc(a,TKa):[]},k5=function(a){return a?'{name:"'+a.name+'",id:'+a.id.substr(0,6)+"..,token:"+((a.token?".."+a.token.slice(-6):"-")+",uuid:"+(a.uuid?".."+a.uuid.slice(-6):"-")+",idType:"+a.idType+"}"):"null"},l5=function(a){return Array.isArray(a)?"["+g.Mc(a,k5).join(",")+"]":"null"},m5=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,
function(a){var b=16*Math.random()|0;
return("x"==a?b:b&3|8).toString(16)})},VKa=function(a){return g.Mc(a,function(b){return{key:b.id,
name:b.name}})},n5=function(a,b){return g.bb(a,function(c){return c||b?!c!=!b?!1:c.id==b.id:!0})},o5=function(a,b){return g.bb(a,function(c){return j5(c,b)})},WKa=function(){var a=(0,g.nv)();
a&&HKa(a,a.i.ph(!0))},p5=function(){var a=g.qv("yt-remote-connected-devices")||[];
g.wb(a);return a},XKa=function(a){if(g.gb(a))return[];
var b=a[0].indexOf("#"),c=-1==b?a[0]:a[0].substring(0,b);return g.Mc(a,function(d,e){return 0==e?d:d.substring(c.length)})},YKa=function(a){g.pv("yt-remote-connected-devices",a,86400)},r5=function(){if(q5)return q5;
...
g.fb(a,b);g.uv()&&g.yb(a,b);a=XKa(a);if(g.gb(a))try{g.Fo("remote_sid")}catch(c){}else try{g.Do("remote_sid",a.join(","),-1)}catch(c){}},ZKa=function(){return g.qv("yt-remote-session-browser-channel")},$Ka=function(){return g.qv("yt-remote-local-screens")||[]},aLa=function(){g.pv("yt-remote-lounge-token-expiration",!0,86400)},bLa=function(a){5<a.length&&(a=a.slice(a.length-5));
var b=g.Mc($Ka(),function(d){return d.loungeToken}),c=g.Mc(a,function(d){return d.loungeToken});
g.hh(c,function(d){return!g.fb(b,d)})&&aLa();
g.pv("yt-remote-local-screens",a,31536E3)},cLa=function(a,b){g.pv("yt-remote-session-browser-channel",a);
g.pv("yt-remote-session-screen-id",b);a=p5();b=r5();g.fb(a,b)||a.push(b);YKa(a);s5()},t5=function(a){a||(g.tv("yt-remote-session-screen-id"),g.tv("yt-remote-session-video-id"));
s5();a=p5();g.kb(a,r5());YKa(a)},dLa=function(){if(!u5){var a=g.oo();
a&&(u5=new g.Qn(a))}},eLa=function(){dLa();
return u5?!!u5.get("yt-remote-use-staging-server"):!1},v5=function(){var a=window.navigator.userAgent.match(/Chrome\/([0-9]+)/);
return a?parseInt(a[1],10):0},fLa=function(a){return!!document.currentScript&&(-1!=document.currentScript.src.indexOf("?"+a)||-1!=document.currentScript.src.indexOf("&"+a))},gLa=function(){return"function"==typeof window.__onGCastApiAvailable?window.__onGCastApiAvailable:null},w5=function(a){a.length?hLa(a.shift(),function(){w5(a)}):x5()},iLa=function(a){return"chrome-extension://"+a+"/cast_sender.js"},hLa=function(a,b,c){var d=document.createElement("script");
d.onerror=b;c&&(d.onload=c);g.id(d,g.hg(a));(document.head||document.documentElement).appendChild(d)},jLa=function(){var a=v5(),b=[];
if(1<a){var c=a-1;b.push("//www.gstatic.com/eureka/clank/"+a+"/cast_sender.js");b.push("//www.gstatic.com/eureka/clank/"+c+"/cast_sender.js")}return b},x5=function(){var a=gLa();
a&&a(!1,"No cast extension found")},y5=function(){if(kLa){var a=2,b=gLa(),c=function(){a--;
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;hLa("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",x5,c)}},lLa=function(){y5();
var a=jLa();a.push("//www.gstatic.com/eureka/clank/cast_sender.js");w5(a)},nLa=function(){y5();
var a=jLa();a.push.apply(a,g.la(mLa.map(iLa)));a.push("//www.gstatic.com/eureka/clank/cast_sender.js");w5(a)},z5=function(a,b,c){g.F.call(this);
...
var b=a.u;a.u=null;a.B.apply(null,b)},C5=function(a){if(g.A.JSON)try{return g.A.JSON.parse(a)}catch(b){}return LKa(a)},D5=function(){},E5=function(a,b){if("function"!==typeof a)throw Error("Fn must not be null and must be a function");
return g.A.setTimeout(function(){a()},b)},G5=function(a){F5.dispatchEvent(new oLa(F5,a))},oLa=function(a,b){g.Fl.call(this,"statevent",a);
this.stat=b},H5=function(){},pLa=function(){},rLa=function(a){return(a=qLa(a))?new ActiveXObject(a):new XMLHttpRequest},qLa=function(a){if(!a.l&&"undefined"==typeof XMLHttpRequest&&"undefined"!=typeof ActiveXObject){for(var b=["MSXML2.XMLHTTP.6.0",
...
this.l=b;this.L=c;this.J=d||1;this.C=45E3;this.B=new g.q0(this);this.u=new g.Im;this.u.setInterval(250)},tLa=function(a,b,c){a.Lq=1;
a.Cl=c5(b.clone());a.Mo=c;a.G=!0;sLa(a,null)},J5=function(a,b,c,d,e){a.Lq=1;
a.Cl=c5(b.clone());a.Mo=null;a.G=c;e&&(a.TI=!1);sLa(a,d)},sLa=function(a,b){a.Cq=Date.now();
K5(a);a.Gm=a.Cl.clone();d5(a.Gm,"t",a.J);a.ju=0;a.Ge=a.i.Jz(a.i.Kt()?b:null);0<a.Iy&&(a.Vw=new A5((0,g.C)(a.JJ,a,a.Ge),a.Iy));a.B.Pa(a.Ge,"readystatechange",a.XR);b=a.Wm?g.Sb(a.Wm):{};a.Mo?(a.Lx="POST",b["Content-Type"]="application/x-www-form-urlencoded",a.Ge.send(a.Gm,a.Lx,a.Mo,b)):(a.Lx="GET",a.TI&&!g.ze&&(b.Connection="close"),a.Ge.send(a.Gm,a.Lx,null,b));a.i.Hi(1)},wLa=function(a,b,c){for(var d=!0;!a.En&&a.ju<c.length;){var e=uLa(a,c);
if(e==L5){4==b&&(a.xl=4,G5(15),d=!1);break}else if(e==vLa){a.xl=4;G5(16);d=!1;break}else M5(a,e)}4==b&&0==c.length&&(a.xl=1,G5(17),d=!1);a.Si=a.Si&&d;d||(N5(a),O5(a))},uLa=function(a,b){var c=a.ju,d=b.indexOf("\n",c);
if(-1==d)return L5;c=Number(b.substring(c,d));if(isNaN(c))return vLa;d+=1;if(d+c>b.length)return L5;b=b.substr(d,c);a.ju=d+c;return b},yLa=function(a,b){a.Cq=Date.now();
K5(a);var c=b?window.location.hostname:"";a.Gm=a.Cl.clone();b5(a.Gm,"DOMAIN",c);b5(a.Gm,"t",a.J);try{a.Wi=new ActiveXObject("htmlfile")}catch(m){N5(a);a.xl=7;G5(22);O5(a);return}var d="<html><body>";if(b){var e="";for(b=0;b<c.length;b++){var f=c.charAt(b);if("<"==f)f=e+"\\x3c";else if(">"==f)f=e+"\\x3e";else{if(f in P5)f=P5[f];else if(f in xLa)f=P5[f]=xLa[f];else{var h=f.charCodeAt(0);if(31<h&&127>h)var l=f;else{if(256>h){if(l="\\x",16>h||256<h)l+="0"}else l="\\u",4096>h&&(l+="0");l+=h.toString(16).toUpperCase()}f=
...
a.C;
zLa(a,a.C)},zLa=function(a,b){if(null!=a.Qq)throw Error("WatchDog timer not null");
...
g.Di(a.Vw);a.Vw=null;a.u.stop();g.nFa(a.B);if(a.Ge){var b=a.Ge;a.Ge=null;b.abort();b.dispose()}a.Wi&&(a.Wi=null)},M5=function(a,b){try{a.i.aI(a,b),a.i.Hi(4)}catch(c){}},BLa=function(a,b,c,d,e){if(0==d)c(!1);
...
KKa(d,a)},R5=function(a){a.onload=null;
a.onerror=null;a.onabort=null;a.ontimeout=null},S5=function(a){g.Zl.call(this);
this.headers=new g.Lm;this.ra=a||null;this.B=!1;this.ma=this.i=null;this.Fa=this.V="";this.G=0;this.u="";this.C=this.Ba=this.L=this.xa=!1;this.J=0;this.X=null;this.La="";this.Y=this.Ea=!1},CLa=function(a){return g.xe&&g.ae(9)&&"number"===typeof a.timeout&&void 0!==a.ontimeout},DLa=function(a){return"content-type"==a.toLowerCase()},FLa=function(a,b){a.B=!1;
a.i&&(a.C=!0,a.i.abort(),a.C=!1);a.u=b;a.G=5;ELa(a);T5(a)},ELa=function(a){a.xa||(a.xa=!0,a.dispatchEvent("complete"),a.dispatchEvent("error"))},HLa=function(a){if(a.B&&"undefined"!=typeof g.u0)if(a.ma[1]&&4==U5(a)&&2==a.getStatus())V5(a,"Local request error detected and ignored");
...
else{a.G=6;try{var l=2<U5(a)?a.i.statusText:""}catch(m){l=""}a.u=l+" ["+a.getStatus()+"]";ELa(a)}}finally{T5(a)}}},T5=function(a,b){if(a.i){ILa(a);
...
a.X&&(g.A.clearTimeout(a.X),a.X=null)},U5=function(a){return a.i?a.i.readyState:0},W5=function(a){try{return a.i?a.i.responseText:""}catch(b){return""}},V5=function(a,b){return b+" ["+a.Fa+" "+a.V+" "+a.getStatus()+"]"},JLa=function(a){this.i=a;
this.l=new D5},KLa=function(a){var b=X5(a.i,a.Gr,"/mail/images/cleardot.gif");
c5(b);BLa(b.toString(),5E3,(0,g.C)(a.EM,a),3,2E3);a.Hi(1)},Z5=function(a){var b=a.i.L;
if(null!=b)G5(5),b?(G5(11),Y5(a.i,a,!1)):(G5(12),Y5(a.i,a,!0));else if(a.Lg=new I5(a,void 0,void 0,void 0),a.Lg.Wm=a.Jy,b=a.i,b=X5(b,b.Kt()?a.vr:null,a.Ky),G5(5),!g.xe||g.be(10))d5(b,"TYPE","xmlhttp"),J5(a.Lg,b,!1,a.vr,!1);else{d5(b,"TYPE","html");var c=a.Lg;a=!!a.vr;c.Lq=3;c.Cl=c5(b.clone());yLa(c,a)}},$5=function(a,b,c){this.eb=1;
this.i=[];this.u=[];this.B=new D5;this.J=a||null;this.L=null!=b?b:null;this.C=c||!1},LLa=function(a,b){this.i=a;
this.map=b;this.context=null},MLa=function(a,b,c,d){g.Fl.call(this,"timingevent",a);
this.size=b;this.Dt=d},NLa=function(a){g.Fl.call(this,"serverreachability",a)},QLa=function(a){OLa(a);
if(3==a.eb){var b=a.Us++,c=a.fv.clone();b5(c,"SID",a.l);b5(c,"RID",b);b5(c,"TYPE","terminate");a6(a,c);b=new I5(a,a.l,b,void 0);b.Lq=2;b.Cl=c5(c.clone());KKa(new Image,b.Cl.toString());b.Cq=Date.now();K5(b)}PLa(a)},RLa=function(a){a.aN(1,0);
a.fv=X5(a,null,a.Ly);b6(a)},OLa=function(a){a.Hl&&(a.Hl.abort(),a.Hl=null);
a.Ud&&(a.Ud.cancel(),a.Ud=null);a.wk&&(g.A.clearTimeout(a.wk),a.wk=null);c6(a);a.xg&&(a.xg.cancel(),a.xg=null);a.Pl&&(g.A.clearTimeout(a.Pl),a.Pl=null)},SLa=function(a,b){if(0==a.eb)throw Error("Invalid operation: sending map when state is closed");
a.i.push(new LLa(a.zO++,b));2!=a.eb&&3!=a.eb||b6(a)},TLa=function(a){var b=0;
a.Ud&&b++;a.xg&&b++;return b},b6=function(a){a.xg||a.Pl||(a.Pl=E5((0,g.C)(a.fI,a),0),a.Tp=0)},VLa=function(a,b){if(1==a.eb){if(!b){a.Us=Math.floor(1E5*Math.random());
b=a.Us++;var c=new I5(a,"",b,void 0);c.Wm=a.qj;var d=d6(a),e=a.fv.clone();b5(e,"RID",b);b5(e,"CVER","1");a6(a,e);tLa(c,e,d);a.xg=c;a.eb=2}}else 3==a.eb&&(b?ULa(a,b):0==a.i.length||a.xg||ULa(a))},ULa=function(a,b){if(b)if(6<a.Fn){a.i=a.u.concat(a.i);
a.u.length=0;var c=a.Us-1;b=d6(a)}else c=b.L,b=b.Mo;else c=a.Us++,b=d6(a);var d=a.fv.clone();b5(d,"SID",a.l);b5(d,"RID",c);b5(d,"AID",a.mq);a6(a,d);c=new I5(a,a.l,c,a.Tp+1);c.Wm=a.qj;c.setTimeout(1E4+Math.round(1E4*Math.random()));a.xg=c;tLa(c,d,b)},a6=function(a,b){a.xf&&(a=a.xf.MF())&&g.Bb(a,function(c,d){b5(b,d,c)})},d6=function(a){var b=Math.min(a.i.length,1E3),c=["count="+b];
...
return c.join("&")},WLa=function(a){a.Ud||a.wk||(a.G=1,a.wk=E5((0,g.C)(a.eI,a),0),a.Ip=0)},e6=function(a){if(a.Ud||a.wk||3<=a.Ip)return!1;
a.G++;a.wk=E5((0,g.C)(a.eI,a),XLa(a,a.Ip));a.Ip++;return!0},Y5=function(a,b,c){a.Jx=c;
a.rj=b.gk;a.C||RLa(a)},c6=function(a){null!=a.Mn&&(g.A.clearTimeout(a.Mn),a.Mn=null)},XLa=function(a,b){var c=5E3+Math.floor(1E4*Math.random());
a.isActive()||(c*=2);return c*b},f6=function(a,b){if(2==b||9==b){var c=null;
a.xf&&(c=null);var d=(0,g.C)(a.AS,a);c||(c=new g.Om("//www.google.com/images/cleardot.gif"),c5(c));ALa(c.toString(),1E4,d)}else G5(2);YLa(a,b)},YLa=function(a,b){a.eb=0;
a.xf&&a.xf.dF(b);PLa(a);OLa(a)},PLa=function(a){a.eb=0;
...
if(""!=d.i)b&&g.Qm(d,b+"."+d.i),g.Rm(d,d.u);else{var e=window.location;d=OKa(e.protocol,b?b+"."+e.hostname:e.hostname,+e.port,c)}a.Vr&&g.Bb(a.Vr,function(f,h){b5(d,h,f)});
b5(d,"VER",a.Fn);a6(a,d);return d},ZLa=function(){},$La=function(){this.i=[];
this.l=[]},aMa=function(a,b){this.action=a;
...
e=void 0===e?!1:e;this.ma=a;this.G=b;this.u=new g.Pn;this.l=new g6(this.hS,this);this.i=null;this.X=!1;this.C=null;this.V="";this.L=this.B=0;this.J=[];this.ra=c;this.Y=d;this.xa=e},bMa=function(a){return{firstTestResults:[""],
secondTestResults:!a.i.Jx,sessionId:a.i.l,arrayId:a.i.mq}},cMa=function(a,b){a.L=b||0;
a.l.stop();i6(a);a.i&&(3==a.i.getState()&&VLa(a.i),QLa(a.i));a.L=0},j6=function(a){return!!a.i&&3==a.i.getState()},i6=function(a){if(a.i){var b=a.Y(),c=a.i.qj||{};
...
method:"POST",context:a,timeout:5E3,withCredentials:!1,onSuccess:g.Pa(a.B,d,!0),onError:g.Pa(a.u,e),onTimeout:g.Pa(a.C,e)};c&&(a.postParams=c,a.headers={"Content-Type":"application/x-www-form-urlencoded"});return g.up(b,a)},gMa=function(){var a=dMa;
eMa();n6.push(a);fMa()},o6=function(a,b){eMa();
var c=hMa(a,String(b));g.gb(n6)?iMa(c):(fMa(),g.zb(n6,function(d){d(c)}))},eMa=function(){n6||(n6=g.Ha("yt.mdx.remote.debug.handlers_")||[],g.Ga("yt.mdx.remote.debug.handlers_",n6,void 0))},iMa=function(a){var b=(p6+1)%50;
p6=b;q6[b]=a;r6||(r6=49==b)},fMa=function(){var a=n6;
if(q6[0]){var b=r6?p6:-1;do{b=(b+1)%50;var c=q6[b];g.zb(a,function(d){d(c)})}while(b!=p6);
q6=Array(50);p6=-1;r6=!1}},hMa=function(a,b){var c=(Date.now()-jMa)/1E3;
c.toFixed&&(c=c.toFixed(3));var d=[];d.push("[",c+"s","] ");d.push("[","yt.mdx.remote","] ");d.push(a+": "+b,"\n");return d.join("")},s6=function(a){g.O.call(this);
this.G=a;this.screens=[]},kMa=function(a,b){var c=a.get(b.uuid)||a.get(b.id);
if(c)return a=c.name,c.id=b.id||c.id,c.name=b.name,c.token=b.token,c.uuid=b.uuid||c.uuid,c.name!=a;a.screens.push(b);return!0},lMa=function(a,b){var c=a.screens.length!=b.length;
a.screens=g.Je(a.screens,function(f){return!!n5(b,f)});
for(var d=0,e=b.length;d<e;d++)c=kMa(a,b[d])||c;return c},mMa=function(a,b){var c=a.screens.length;
...
this.l=a;this.i=NaN;u6(this);this.info("Initializing with "+l5(this.screens))},nMa=function(a){if(a.screens.length){var b=g.Mc(a.screens,function(d){return d.id}),c=l6(a.l,"/pairing/get_lounge_token_batch");
m6(a.l,c,{screen_ids:b.join(",")},(0,g.C)(a.xN,a),(0,g.C)(a.wN,a))}},u6=function(a){if(g.Oo("deprecate_pair_servlet_enabled"))return lMa(a,[]);
var b=UKa($Ka());b=g.Je(b,function(c){return!c.uuid});
return lMa(a,b)},w6=function(a,b){bLa(g.Mc(a.screens,SKa));
b&&aLa()},y6=function(a,b){g.O.call(this);
...
else{c=g.Jb(b);for(var d=0,e=c.length;d<e;++d)if(!a.i[c[d]]){c=!1;break a}c=!0}c||(x6("Updated online screens: "+g.Aj(a.i)),a.i=b,a.W("screenChange"));oMa(a)},B6=function(a){isNaN(a.u)||g.pp(a.u);
a.u=g.np((0,g.C)(a.RB,a),0<a.B&&a.B<g.Sa()?2E4:1E4)},x6=function(a){o6("OnlineScreenService",a)},pMa=function(a){var b={};
g.zb(a.G(),function(c){c.token?b[c.token]=c.id:this.Gd("Requesting availability of screen w/o lounge token.")});
return b},oMa=function(a){a=g.Jb(g.Cb(a.i,function(b){return b}));
...
s6.call(this,"ScreenService");this.B=a;this.J=b;this.i=this.l=null;this.u=[];this.C={};qMa(this)},sMa=function(a,b,c,d,e,f){a.info("getAutomaticScreenByIds "+c+" / "+b);
c||(c=a.C[b]);var h=a.Xg(),l=c?o5(h,c):null;c&&(a.J||l)||(l=o5(h,b));if(l){l.uuid=b;var m=D6(a,l);z6(a.i,m,function(n){e(n?m:null)})}else c?rMa(a,c,(0,g.C)(function(n){var p=D6(this,new i5({name:d,
screenId:c,loungeToken:n,dialId:b||""}));z6(this.i,p,function(r){e(r?p:null)})},a),f):e(null)},tMa=function(a,b){for(var c=0,d=a.screens.length;c<d;++c)if(a.screens[c].name==b)return a.screens[c];
return null},uMa=function(a,b,c){z6(a.i,b,c)},rMa=function(a,b,c,d){a.info("requestLoungeToken_ for "+b);
...
g.up(l6(a.B,"/pairing/get_lounge_token_batch"),e)},vMa=function(a){a.screens=a.l.Xg();
var b=a.C,c={},d;for(d in b)c[b[d]]=d;b=0;for(d=a.screens.length;b<d;++b){var e=a.screens[b];e.uuid=c[e.id]||""}a.info("Updated manual screens: "+l5(a.screens))},qMa=function(a){E6(a);
a.l=new v6(a.B);a.l.subscribe("screenChange",(0,g.C)(a.DN,a));vMa(a);a.J||(a.u=UKa(g.qv("yt-remote-automatic-screen-cache")||[]));E6(a);a.info("Initializing automatic screens: "+l5(a.u));a.i=new y6(a.B,(0,g.C)(a.Xg,a,!0));a.i.subscribe("screenChange",(0,g.C)(function(){this.W("onlineScreenChange")},a))},D6=function(a,b){var c=a.get(b.id);
c?(c.uuid=b.uuid,b=c):((c=o5(a.u,b.uuid))?(c.id=b.id,c.token=b.token,b=c):a.u.push(b),a.J||wMa(a));E6(a);a.C[b.uuid]=b.id;g.pv("yt-remote-device-id-map",a.C,31536E3);return b},wMa=function(a){a=g.Je(a.u,function(b){return"shortLived"!=b.idType});
g.pv("yt-remote-automatic-screen-cache",g.Mc(a,SKa))},E6=function(a){a.C=g.qv("yt-remote-device-id-map")||{}},F6=function(a,b,c){g.O.call(this);
this.xa=c;this.u=a;this.i=b;this.B=null},G6=function(a,b){a.B=b;
a.W("sessionScreen",a.B)},xMa=function(a,b){a.B&&(a.B.token=b,D6(a.u,a.B));
a.W("sessionScreen",a.B)},H6=function(a,b){o6(a.xa,b)},I6=function(a,b,c){F6.call(this,a,b,"CastSession");
var d=this;this.Ba=c;this.l=null;this.Y=(0,g.C)(this.QL,this);this.ra=(0,g.C)(this.HR,this);this.X=g.np(function(){yMa(d,null)},12E4);
this.J=this.C=this.G=this.L=0;this.ma=!1;this.V="unknown"},J6=function(a,b){g.pp(a.J);
a.J=0;0==b?zMa(a):a.J=g.np(function(){zMa(a)},b)},zMa=function(a){AMa(a,"getLoungeToken");
g.pp(a.C);a.C=g.np(function(){BMa(a,null)},3E4)},AMa=function(a,b){a.info("sendYoutubeMessage_: "+b+" "+g.Aj(void 0));
var c={};c.type=b;a.l?a.l.sendMessage("urn:x-cast:com.google.youtube.mdx",c,g.Ia,(0,g.C)(function(){H6(this,"Failed to send message: "+b+".")},a)):H6(a,"Sending yt message without session: "+g.Aj(c))},K6=function(a,b){b?(a.info("onConnectedScreenId_: Received screenId: "+b),a.getScreen()&&a.getScreen().id==b||a.bG(b,function(c){G6(a,c)},function(){return a.ag()},5)):a.ag(Error("Waiting for session status timed out."))},DMa=function(a,b,c){a.info("onConnectedScreenData_: Received screenData: "+JSON.stringify(b));
var d=new i5(b);CMa(a,d,function(e){e?(a.ma=!0,D6(a.u,d),G6(a,d),a.V="unknown",J6(a,c)):(g.To(Error("CastSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online.")),a.ag())},5)},yMa=function(a,b){g.pp(a.X);
...
return!!(a.Ea.enableDialLoungeToken&&(null==(b=a.l)?0:b.getDialAppInfo))},FMa=function(a){a.C=a.u.TD(a.ra,a.i.label,a.i.friendlyName,M6(a),function(b,c){a.C=g.Ia;
a.Y=!0;G6(a,b);"shortLived"==b.idType&&0<c&&N6(a,c)},function(b){a.C=g.Ia;
a.ag(b)})},GMa=function(a){var b={};
b.pairingCode=a.ra;b.theme=a.Fa;eLa()&&(b.env_useStageMdx=1);return g.Jd(b)},O6=function(a){return new Promise(function(b){a.ra=m5();
if(a.Ca){var c=new chrome.cast.DialLaunchResponse(!0,GMa(a));b(c);FMa(a)}else a.X=function(){g.pp(a.V);a.X=function(){};
a.V=NaN;var d=new chrome.cast.DialLaunchResponse(!0,GMa(a));b(d);FMa(a)},a.V=g.np(function(){a.X()},100)})},IMa=function(a,b,c){a.info("initOnConnectedScreenDataPromise_: Received screenData: "+JSON.stringify(b));
var d=new i5(b);return(new Promise(function(e){HMa(a,d,function(f){f?(a.Y=!0,D6(a.u,d),G6(a,d),N6(a,c)):g.To(Error("DialSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online."));e(f)},5)})).then(function(e){return e?new chrome.cast.DialLaunchResponse(!1):O6(a)})},JMa=function(a,b){var c=a.L.receiver.label,d=a.i.friendlyName;
return(new Promise(function(e){sMa(a.u,c,b,d,function(f){f&&f.token&&G6(a,f);e(f)},function(f){H6(a,"Failed to get DIAL screen: "+f);
e(null)})})).then(function(e){return e&&e.token?new chrome.cast.DialLaunchResponse(!1):O6(a)})},HMa=function(a,b,c,d){g.pp(a.G);
a.G=0;uMa(a.u,b,function(e){e||0>d?c(e):a.G=g.np(function(){HMa(a,b,c,d-1)},300)})},N6=function(a,b){a.info("getDialAppInfoWithTimeout_ "+b);
M6(a)&&(g.pp(a.J),a.J=0,0==b?KMa(a):a.J=g.np(function(){KMa(a)},b))},KMa=function(a){M6(a)&&a.l.getDialAppInfo(function(b){a.info("getDialAppInfo dialLaunchData: "+JSON.stringify(b));
b=b.extraData||{};var c=null;if(b.loungeToken){var d;(null==(d=a.getScreen())?void 0:d.token)==b.loungeToken&&(c="staleLoungeToken")}else c="missingLoungeToken";c?(a.ma=c,N6(a,3E4)):(a.Y=!1,a.ma="unknown",xMa(a,b.loungeToken),N6(a,b.loungeTokenRefreshIntervalMs))},function(b){a.info("getDialAppInfo error: "+b);
a.ma="noLoungeTokenResponse";N6(a,3E4)})},LMa=function(a){g.pp(a.G);
...
this.B=b;this.l=a;this.L=b.appId||"233637DE";this.C=b.theme||"cl";this.V=b.disableCastApi||!1;this.i=null;this.J=!1;this.u=[];this.G=(0,g.C)(this.DQ,this)},MMa=function(a,b){return b?g.bb(a.u,function(c){return j5(b,c.label)},a):null},R6=function(a){o6("Controller",a)},dMa=function(a){window.chrome&&chrome.cast&&chrome.cast.logMessage&&chrome.cast.logMessage(a)},S6=function(a){return a.J||!!a.u.length||!!a.i},T6=function(a,b,c){b!=a.i&&(g.Di(a.i),(a.i=b)?(c?a.W("yt-remote-cast2-receiver-resumed",
b.i):a.W("yt-remote-cast2-receiver-selected",b.i),b.subscribe("sessionScreen",(0,g.C)(a.dI,a,b)),b.getScreen()?a.W("yt-remote-cast2-session-change",b.getScreen()):c&&a.i.nq(null)):a.W("yt-remote-cast2-session-change",null))},NMa=function(a){var b=a.l.SD(),c=a.i&&a.i.i;
a=g.Mc(b,function(d){c&&j5(d,c.label)&&(c=null);var e=d.uuid?d.uuid:d.id,f=MMa(this,d);f?(f.label=e,f.friendlyName=d.name):(f=new chrome.cast.Receiver(e,d.name),f.receiverType=chrome.cast.ReceiverType.CUSTOM);return f},a);
c&&(c.receiverType!=chrome.cast.ReceiverType.CUSTOM&&(c=new chrome.cast.Receiver(c.label,c.friendlyName),c.receiverType=chrome.cast.ReceiverType.CUSTOM),a.push(c));return a},SMa=function(a,b,c,d){d.disableCastApi?U6("Cannot initialize because disabled by Mdx config."):OMa()?PMa(b,d)&&(V6(!0),window.chrome&&chrome.cast&&chrome.cast.isAvailable?QMa(a,c):(window.__onGCastApiAvailable=function(e,f){e?QMa(a,c):(W6("Failed to load cast API: "+f),X6(!1),V6(!1),g.tv("yt-remote-cast-available"),g.tv("yt-remote-cast-receiver"),
RMa(),c(!1))},d.loadCastApiSetupScript?g.vv("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"):0<=window.navigator.userAgent.indexOf("Android")&&0<=window.navigator.userAgent.indexOf("Chrome/")&&window.navigator.presentation?60<=v5()&&lLa():!window.chrome||!window.navigator.presentation||0<=window.navigator.userAgent.indexOf("Edge")?x5():89<=v5()?nLa():(y5(),w5(mLa.map(iLa))))):U6("Cannot initialize because not running Chrome")},RMa=function(){U6("dispose");
var a=Y6();a&&a.dispose();g.Ga("yt.mdx.remote.cloudview.instance_",null,void 0);TMa(!1);g.Tq(Z6);Z6.length=0},$6=function(){return!!g.qv("yt-remote-cast-installed")},UMa=function(){var a=g.qv("yt-remote-cast-receiver");
return a?a.friendlyName:null},VMa=function(){U6("clearCurrentReceiver");
g.tv("yt-remote-cast-receiver")},WMa=function(){return $6()?Y6()?Y6().getCastSession():(W6("getCastSelector: Cast is not initialized."),null):(W6("getCastSelector: Cast API is not installed!"),null)},b7=function(){$6()?Y6()?a7()?(U6("Requesting cast selector."),Y6().requestSession()):(U6("Wait for cast API to be ready to request the session."),Z6.push(g.Sq("yt-remote-cast2-api-ready",b7))):W6("requestCastSelector: Cast is not initialized."):W6("requestCastSelector: Cast API is not installed!")},c7=
function(a,b){a7()?Y6().setConnectedScreenStatus(a,b):W6("setConnectedScreenStatus called before ready.")},OMa=function(){var a=0<=g.Uc.search(/ (CrMo|Chrome|CriOS)\//);
return g.rB||a},XMa=function(a,b){Y6().init(a,b)},PMa=function(a,b){var c=!1;
...
U6("cloudview.createSingleton_: "+c);return c},Y6=function(){return g.Ha("yt.mdx.remote.cloudview.instance_")},QMa=function(a,b){X6(!0);
V6(!1);XMa(a,function(c){c?(TMa(!0),g.Uq("yt-remote-cast2-api-ready")):(W6("Failed to initialize cast API."),X6(!1),g.tv("yt-remote-cast-available"),g.tv("yt-remote-cast-receiver"),RMa());b(c)})},U6=function(a){o6("cloudview",a)},W6=function(a){o6("cloudview",a)},X6=function(a){U6("setCastInstalled_ "+a);
g.pv("yt-remote-cast-installed",a)},a7=function(){return!!g.Ha("yt.mdx.remote.cloudview.apiReady_")},TMa=function(a){U6("setApiReady_ "+a);
...
this.eb=0;this.u=a;this.C=[];this.B=new $La;this.l=this.i=null;this.L=(0,g.C)(this.hP,this);this.G=(0,g.C)(this.Xs,this);this.J=(0,g.C)(this.gP,this);this.V=(0,g.C)(this.oP,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.dC,this),YMa(this))):c=3;0!=c&&(b?this.dC(c):g.np((0,g.C)(function(){this.dC(c)},this),0));
(a=WMa())&&k7(this,a);this.subscribe("yt-remote-cast2-session-change",this.V)},m7=function(a){return new d7(a.u.getPlayerContextData())},YMa=function(a){g.zb("nowAutoplaying autoplayDismissed remotePlayerChange remoteQueueChange autoplayModeChange autoplayUpNext previousNextChange".split(" "),function(b){this.C.push(this.u.subscribe(b,g.Pa(this.AQ,b),this))},a)},ZMa=function(a){g.zb(a.C,function(b){this.u.unsubscribeByKey(b)},a);
...
g7(d,c);-1E3!=d.playerState&&(d.playerState=b);p7(a,d)},r7=function(a,b,c){a.u.sendMessage(b,c)},p7=function(a,b){ZMa(a);
a.u.setPlayerContextData(j7(b));YMa(a)},k7=function(a,b){a.l&&(a.l.removeUpdateListener(a.L),a.l.removeMediaListener(a.G),a.Xs(null));
a.l=b;a.l&&(o6("CP","Setting cast session: "+a.l.sessionId),a.l.addUpdateListener(a.L),a.l.addMediaListener(a.G),a.l.media.length&&a.Xs(a.l.media[0]))},$Ma=function(a){var b=a.i.media,c=a.i.customData;
...
this.C=NaN;this.ma=!1;this.L=this.J=this.X=this.Y=NaN;this.V=[];this.B=this.G=this.u=this.ac=this.i=null;this.xa=a;this.V.push(g.Tp(window,"beforeunload",(0,g.C)(this.tN,this)));this.l=[];this.ac=new d7;this.Ba=b.id;this.ra=b.idType;this.i=aNa(this,c);this.i.subscribe("handlerOpened",this.lP,this);this.i.subscribe("handlerClosed",this.iP,this);this.i.subscribe("handlerError",this.jP,this);this.i.subscribe("handlerMessage",this.kP,this);this.i.jx(b.token);this.subscribe("remoteQueueChange",function(){var d=
this.ac.videoId;g.uv()&&g.pv("yt-remote-session-video-id",d)},this)},u7=function(a){o6("conn",a)},aNa=function(a,b){return new h6(l6(a.xa,"/bc"),b,!1,function(){return a.XD()},"shortLived"==a.ra)},v7=function(a,b){a.W("proxyStateChange",b)},bNa=function(a){a.C=g.np((0,g.C)(function(){u7("Connecting timeout");
this.Pp(1)},a),2E4)},w7=function(a){g.pp(a.C);
a.C=NaN},x7=function(a){g.pp(a.Y);
a.Y=NaN},cNa=function(a){y7(a);
a.X=g.np((0,g.C)(function(){z7(this,"getNowPlaying")},a),2E4)},y7=function(a){g.pp(a.X);
a.X=NaN},eNa=function(a,b){b&&(w7(a),x7(a));
var c=j6(a.i)&&isNaN(a.C);b==c?b&&(v7(a,1),z7(a,"getSubtitlesTrack")):b?(a.aG()&&a.ac.reset(),v7(a,1),z7(a,"getNowPlaying"),dNa(a)):a.Pp(1)},fNa=function(a,b){var c=b.params.videoId;
delete b.params.videoId;c==a.ac.videoId&&(g.Ob(b.params)?a.ac.trackData=null:a.ac.trackData=b.params,a.W("remotePlayerChange"))},gNa=function(a,b){var c=b.params.videoId||b.params.video_id,d=parseInt(b.params.currentIndex,10);
a.ac.listId=b.params.listId||a.ac.listId;i7(a.ac,c,d);a.W("remoteQueueChange")},iNa=function(a,b){b.params=b.params||{};
gNa(a,b);hNa(a,b);a.W("autoplayDismissed")},hNa=function(a,b){var c=parseInt(b.params.currentTime||b.params.current_time,10);
g7(a.ac,isNaN(c)?0:c);c=parseInt(b.params.state,10);c=isNaN(c)?-1:c;-1==c&&-1E3==a.ac.playerState&&(c=-1E3);a.ac.playerState=c;c=Number(b.params.loadedTime);a.ac.L=isNaN(c)?0:c;c=Number(b.params.duration);a.ac.C=isNaN(c)?0:c;c=a.ac;var d=Number(b.params.liveIngestionTime);c.u=d;c.l=isNaN(d)?!1:!0;c=a.ac;d=Number(b.params.seekableStartTime);b=Number(b.params.seekableEndTime);c.B=isNaN(d)?0:d;c.i=isNaN(b)?0:b;1==a.ac.playerState?cNa(a):y7(a);a.W("remotePlayerChange")},jNa=function(a,b){if(-1E3!=a.ac.playerState){var c=
1085;
switch(parseInt(b.params.adState,10)){case 1:c=1081;break;case 2:c=1084;break;case 0:c=1083}a.ac.playerState=c;b=parseInt(b.params.currentTime,10);g7(a.ac,isNaN(b)?0:b);a.W("remotePlayerChange")}},kNa=function(a,b){var c="true"==b.params.muted;
a.ac.volume=parseInt(b.params.volume,10);a.ac.muted=c;a.W("remotePlayerChange")},lNa=function(a,b){a.G=b.params.videoId;
a.W("nowAutoplaying",parseInt(b.params.timeout,10))},mNa=function(a,b){var c="true"==b.params.hasNext;
a.ac.Fj="true"==b.params.hasPrevious;a.ac.hasNext=c;a.W("previousNextChange")},dNa=function(a){g.pp(a.L);
...
this.Df=a;this.i=[];this.i.push(this.Df.$_s("screenChange",(0,g.C)(this.VL,this)));this.i.push(this.Df.$_s("onlineScreenChange",(0,g.C)(this.hQ,this)))},qNa=function(a,b){dLa();
if(!u5||!u5.get("yt-remote-disable-remote-module-for-dev")){b=g.M("MDX_CONFIG")||b;WKa();s5();B7||(B7=new k6(b?b.loungeApiHost:void 0),eLa()&&(B7.i="/api/loungedev"));C7||(C7=g.Ha("yt.mdx.remote.deferredProxies_")||[],g.Ga("yt.mdx.remote.deferredProxies_",C7,void 0));nNa();var c=D7();if(!c){var d=new C6(B7,b?b.disableAutomaticScreenCache||!1:!1);g.Ga("yt.mdx.remote.screenService_",d,void 0);c=D7();var e={};b&&(e={appId:b.appId,disableDial:b.disableDial,theme:b.theme,loadCastApiSetupScript:b.loadCastApiSetupScript,
disableCastApi:b.disableCastApi,enableDialLoungeToken:b.enableDialLoungeToken,enableCastLoungeToken:b.enableCastLoungeToken});SMa(a,d,function(f){f?E7()&&c7(E7(),"YouTube TV"):d.subscribe("onlineScreenChange",function(){g5("yt-remote-receiver-availability-change")})},e)}b&&!g.Ha("yt.mdx.remote.initialized_")&&(g.Ga("yt.mdx.remote.initialized_",!0,void 0),F7("Initializing: "+g.Aj(b)),G7.push(g.Sq("yt-remote-cast2-availability-change",function(){g5("yt-remote-receiver-availability-change")})),G7.push(g.Sq("yt-remote-cast2-receiver-selected",
function(){H7(null);
g5("yt-remote-auto-connect","cast-selector-receiver")})),G7.push(g.Sq("yt-remote-cast2-receiver-resumed",function(){g5("yt-remote-receiver-resumed","cast-selector-receiver")})),G7.push(g.Sq("yt-remote-cast2-session-change",oNa)),G7.push(g.Sq("yt-remote-connection-change",function(f){f?c7(E7(),"YouTube TV"):I7()||(c7(null,null),VMa())})),a=J7(),b.isAuto&&(a.id+="#dial"),e=b.capabilities||[],g.Oo("desktop_enable_autoplay")&&e.push("atp"),0<e.length&&(a.capabilities=e),a.name=b.device,a.app=b.app,(b=
b.theme)&&(a.theme=b),F7(" -- with channel params: "+g.Aj(a)),a?(g.pv("yt-remote-session-app",a.app),g.pv("yt-remote-session-name",a.name)):(g.tv("yt-remote-session-app"),g.tv("yt-remote-session-name")),g.Ga("yt.mdx.remote.channelParams_",a,void 0),c.start(),E7()||pNa())}},rNa=function(){var a=D7().Df.$_gos();
var b=K7();b&&L7()&&(n5(a,b)||a.push(b));return VKa(a)},M7=function(){var a=sNa();
!a&&$6()&&UMa()&&(a={key:"cast-selector-receiver",name:UMa()});return a},sNa=function(){var a=rNa(),b=K7();
b||(b=I7());return g.bb(a,function(c){return b&&j5(b,c.key)?!0:!1})},K7=function(){var a=E7();
if(!a)return null;var b=D7().Xg();return o5(b,a)},oNa=function(a){F7("remote.onCastSessionChange_: "+k5(a));
...
S7=a?new A7(a):null}return S7},E7=function(){return g.Ha("yt.mdx.remote.currentScreenId_")},tNa=function(a){g.Ga("yt.mdx.remote.currentScreenId_",a,void 0)},uNa=function(){return g.Ha("yt.mdx.remote.connectData_")},H7=function(a){g.Ga("yt.mdx.remote.connectData_",a,void 0)},L7=function(){return g.Ha("yt.mdx.remote.connection_")},Q7=function(a){var b=L7();
H7(null);a||tNa("");g.Ga("yt.mdx.remote.connection_",a,void 0);C7&&(g.zb(C7,function(c){c(a)}),C7.length=0);
...
K7()&&K7();T7?N7=a:(tNa(a.id),a=new t7(B7,a,J7()),a.connect(b,uNa()),a.subscribe("beforeDisconnect",function(c){g5("yt-remote-before-disconnect",c)}),a.subscribe("beforeDispose",function(){L7()&&(L7(),Q7(null))}),a.subscribe("browserChannelAuthError",function(){var c=K7();
c&&"shortLived"==c.idType&&(a7()?Y6().handleBrowserChannelAuthError():W6("refreshLoungeToken called before API ready."))}),Q7(a))},pNa=function(){var a=I7();
a?(F7("Resume connection to: "+k5(a)),P7(a,0)):(t5(),VMa(),F7("Skipping connecting because no session screen found."))},nNa=function(){var a=J7();
...
var d=this;this.l=a;this.I=b;this.Ob=c;this.events=new g.vM(this);this.X=this.events.N(this.I,"onVolumeChange",function(e){vNa(d,e)});
...
a=this.Ob;a.Ga();a.subscribe("proxyStateChange",this.ZH,this);a.subscribe("remotePlayerChange",this.jt,this);a.subscribe("remoteQueueChange",this.Nw,this);a.subscribe("previousNextChange",this.WH,this);a.subscribe("nowAutoplaying",this.QH,this);a.subscribe("autoplayDismissed",this.qH,this);g.G(this,this.i);g.G(this,this.u);g.G(this,this.L);g.G(this,this.V);g.G(this,this.J);this.hJ();this.Nw();this.jt()},vNa=function(a,b){if(V7(a)){a.Ob.unsubscribe("remotePlayerChange",a.jt,a);
var c=Math.round(b.volume);b=!!b.muted;var d=m7(a.Ob);if(c!==d.volume||b!==d.muted)a.Ob.setVolume(c,b),a.V.start();a.Ob.subscribe("remotePlayerChange",a.jt,a)}},wNa=function(a){a.Sb(0);
...
if(null===c||void 0===c?0:c.listId){var d=c.index;var e=c.listId.toString()}c=a.I.getVideoData(1);a.Ob.playVideo(c.videoId,b,d,e,c.playerParams,c.Ba,IKa(c));a.Hb(new g.yJ(1))},xNa=function(a,b){if(b){var c=a.I.getOption("captions","tracklist",{rG:1});
...
K:"ytp-mdx-manual-pairing-popup-dialog",U:{role:"dialog"},S:[{D:"div",K:"ytp-mdx-manual-pairing-popup-dialog-inner-content",S:[{D:"div",K:"ytp-mdx-manual-pairing-popup-title",oa:"T\u00ednh n\u0103ng d\u00f9ng m\u00e3 \u0111\u1ec3 k\u1ebft n\u1ed1i m\u1ea1ng cho TV s\u1eafp ng\u1eebng ho\u1ea1t \u0111\u1ed9ng"},{D:"div",K:"ytp-mdx-manual-pairing-popup-buttons",S:[{D:"button",Da:["ytp-button","ytp-mdx-manual-pairing-popup-learn-more"],oa:"T\u00ecm hi\u1ec3u th\u00eam"},{D:"button",Da:["ytp-button",
"ytp-mdx-manual-pairing-popup-ok"],oa:"OK"}]}]}]});this.i=new g.dL(this,250);this.learnMoreButton=this.Aa("ytp-mdx-manual-pairing-popup-learn-more");this.okButton=this.Aa("ytp-mdx-manual-pairing-popup-ok");g.G(this,this.i);this.N(this.learnMoreButton,"click",this.l);this.N(this.okButton,"click",this.u)},Z7=function(){g.V.call(this,{D:"div",
...
{D:"div",K:"ytp-mdx-privacy-popup-buttons",S:[{D:"button",Da:["ytp-button","ytp-mdx-privacy-popup-cancel"],oa:"H\u1ee7y"},{D:"button",Da:["ytp-button","ytp-mdx-privacy-popup-confirm"],oa:"X\u00e1c nh\u1eadn"}]}]}]});this.i=new g.dL(this,250);this.cancelButton=this.Aa("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Aa("ytp-mdx-privacy-popup-confirm");g.G(this,this.i);this.N(this.cancelButton,"click",this.l);this.N(this.confirmButton,"click",this.u)},$7=function(a){g.V.call(this,{D:"div",
K:"ytp-remote",S:[{D:"div",K:"ytp-remote-display-status",S:[{D:"div",K:"ytp-remote-display-status-icon",S:[g.hna()]},{D:"div",K:"ytp-remote-display-status-text",oa:"{{statustext}}"}]}]});this.api=a;this.i=new g.dL(this,250);g.G(this,this.i);this.N(a,"presentingplayerstatechange",this.l);yNa(this,a.sb())},yNa=function(a,b){if(3===a.api.getPresentingPlayerType()){var c={RECEIVER_NAME:a.api.getOption("remote","currentReceiver").name};
b=g.U(b,128)?g.aI("L\u1ed7i tr\u00ean $RECEIVER_NAME",c):b.lc()||g.U(b,4)?g.aI("\u0110ang ph\u00e1t tr\u00ean $RECEIVER_NAME",c):g.aI("\u0110\u00e3 k\u1ebft n\u1ed1i v\u1edbi $RECEIVER_NAME",c);a.Qa("statustext",b);a.i.show()}else a.i.hide()},a8=function(a,b){g.oP.call(this,"Ph\u00e1t tr\u00ean",0,a,b);
...
this.Ei={key:m5(),name:"M\u00e1y t\u00ednh n\u00e0y"};this.qh=null;this.subscriptions=[];this.GB=this.Ob=null;this.Dm=[this.Ei];this.Jl=this.Ei;this.Xc=new g.yJ(64);this.MG=0;this.Oe=-1;this.rq=null;this.qt=this.jw=!1;this.Xk=this.Aq=null;if(!g.ID(this.player.T())&&!g.JD(this.player.T())){a=this.player;var b=g.iM(a);b&&(b=b.Zl())&&(b=new a8(a,b),g.G(this,b));b=new $7(a);g.G(this,b);g.sM(a,b.element,4);this.Aq=new Z7;g.G(this,this.Aq);g.sM(a,this.Aq.element,4);g.S(this.player.T().experiments,"pair_servlet_deprecation_warning_enabled")&&
!g.S(this.player.T().experiments,"deprecate_pair_servlet_enabled")&&(this.rq=new Y7,g.G(this,this.rq),g.sM(a,this.rq.element,4));this.qt=!!I7();this.jw=!!g.qv("yt-remote-manual-pairing-warning-shown")}},c8=function(a){a.Xk&&(a.player.removeEventListener("presentingplayerstatechange",a.Xk),a.Xk=null)},zNa=function(a,b,c){a.Xc=c;
a.player.W("presentingplayerstatechange",new g.NH(c,b))},ANa=function(a,b,c){var d=!1;
1===b?d=!a.qt:2===b&&(d=!a.jw);d&&g.PH(c,8)&&(a.player.pauseVideo(),c8(a))},d8=function(a,b){if(b.key!==a.Jl.key)if(b.key===a.Ei.key)O7();
else{if(a.rq&&!a.jw&&b!==a.Ei&&"cast-selector-receiver"!==b.key&&g.dE(a.player.T()))BNa(a);else{var c;(c=!g.S(a.player.T().experiments,"mdx_enable_privacy_disclosure_ui"))||(c=((c=g.M("PLAYER_CONFIG"))&&c.args&&void 0!==c.args.authuser?!0:!(!g.M("SESSION_INDEX")&&!g.M("LOGGED_IN")))||a.qt||!a.Aq);(c?0:g.dE(a.player.T())||g.hE(a.player.T()))&&CNa(a)}a.Jl=b;var d=a.player.getPlaylistId();c=a.player.getVideoData(1);var e=c.videoId;if(!d&&!e||(2===a.player.getAppState()||1===a.player.getAppState())&&
g.S(a.player.T().experiments,"should_clear_video_data_on_player_cued_unstarted"))a=null;else{var f=a.player.getPlaylist();if(f){var h=[];for(var l=0;l<f.length;l++)h[l]=f.bb(l).videoId}else h=[e];f=a.player.getCurrentTime(1);a={videoIds:h,listId:d,videoId:e,playerParams:c.playerParams,clickTrackingParams:c.Ba,index:Math.max(a.player.getPlaylistIndex(),0),currentTime:0===f?void 0:f};(c=IKa(c))&&(a.locationInfo=c)}F7("Connecting to: "+g.Aj(b));"cast-selector-receiver"==b.key?(H7(a||null),b=a||null,
a7()?Y6().setLaunchParams(b):W6("setLaunchParams called before ready.")):!a&&R7()&&E7()==b.key?g5("yt-remote-connection-change",!0):(O7(),H7(a||null),a=D7().Xg(),(b=o5(a,b.key))&&P7(b,1))}},CNa=function(a){a.player.sb().lc()?a.player.pauseVideo():(a.Xk=function(b){ANa(a,1,b)},a.player.addEventListener("presentingplayerstatechange",a.Xk));
a.Aq&&a.Aq.Oc();L7()||(T7=!0)},BNa=function(a){a.player.sb().lc()?a.player.pauseVideo():(a.Xk=function(b){ANa(a,2,b)},a.player.addEventListener("presentingplayerstatechange",a.Xk));
a.rq&&a.rq.Oc();L7()||(T7=!0)},xLa={"\x00":"\\0",
"\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\x0B":"\\x0B",'"':'\\"',"\\":"\\\\","<":"\\u003C"},P5={"'":"\\'"},DNa={},RKa={QT:"atp",D3:"ska",v2:"que",B0:"mus",C3:"sus",LX:"dsp",O2:"seq",b0:"mic",MW:"dpa",gU:"cds",z0:"mlm"},u5,q5="",kLa=fLa("loadCastFramework")||fLa("loadCastApplicationFramework"),mLa=["pkedcjkdefgpdelpbcmbmeomcjbeemfm","enhhojjnijigcajfphajepfemndkmdlo"];/*
...
D5.prototype.parse=function(a){return g.A.JSON.parse(a,void 0)};var F5=new g.Zl;g.v(oLa,g.Fl);H5.prototype.i=null;H5.prototype.getOptions=function(){var a;(a=this.i)||(a={},qLa(this)&&(a[0]=!0,a[1]=!0),a=this.i=a);return a};var e8;g.Ta(pLa,H5);e8=new pLa;g.k=I5.prototype;g.k.Wm=null;g.k.Si=!1;g.k.Qq=null;g.k.RC=null;g.k.Cq=null;g.k.Lq=null;g.k.Cl=null;g.k.Gm=null;g.k.Mo=null;g.k.Ge=null;g.k.ju=0;g.k.Wi=null;g.k.Lx=null;g.k.xl=null;g.k.rr=-1;g.k.TI=!0;g.k.En=!1;g.k.Iy=0;g.k.Vw=null;var vLa={},L5={};g.k=I5.prototype;g.k.setTimeout=function(a){this.C=a};
g.k.XR=function(a){a=a.target;var b=this.Vw;b&&3==U5(a)?b.wg():this.JJ(a)};
g.k.JJ=function(a){try{if(a==this.Ge)a:{var b=U5(this.Ge),c=this.Ge.G,d=this.Ge.getStatus();if(g.xe&&!g.be(10)||g.ze&&!g.ae("420+")){if(4>b)break a}else if(3>b||3==b&&!g.mg&&!W5(this.Ge))break a;this.En||4!=b||7==c||(8==c||0>=d?this.i.Hi(3):this.i.Hi(2));Q5(this);var e=this.Ge.getStatus();this.rr=e;var f=W5(this.Ge);(this.Si=200==e)?(4==b&&N5(this),this.G?(wLa(this,b,f),g.mg&&this.Si&&3==b&&(this.B.Pa(this.u,"tick",this.SR),this.u.start())):M5(this,f),this.Si&&!this.En&&(4==b?this.i.Cu(this):(this.Si=
...
g.k.SR=function(){var a=U5(this.Ge),b=W5(this.Ge);this.ju<b.length&&(Q5(this),wLa(this,a,b),this.Si&&4!=a&&K5(this))};
...
g.k.DR=function(){this.Qq=null;var a=Date.now();0<=a-this.RC?(2!=this.Lq&&this.i.Hi(3),N5(this),this.xl=2,G5(18),O5(this)):zLa(this,this.RC-a)};
g.k.getLastError=function(){return this.xl};g.Ta(S5,g.Zl);var GLa=/^https?$/i,ENa=["POST","PUT"];g.k=S5.prototype;
g.k.send=function(a,b,c,d){if(this.i)throw Error("[goog.net.XhrIo] Object is active with another request="+this.V+"; newUri="+a);b=b?b.toUpperCase():"GET";this.V=a;this.u="";this.G=0;this.Fa=b;this.xa=!1;this.B=!0;this.i=this.ra?rLa(this.ra):rLa(e8);this.ma=this.ra?this.ra.getOptions():e8.getOptions();this.i.onreadystatechange=(0,g.C)(this.XH,this);try{f5(V5(this,"Opening Xhr")),this.Ba=!0,this.i.open(b,String(a),!0),this.Ba=!1}catch(f){f5(V5(this,"Error opening Xhr: "+f.message));FLa(this,f);return}a=
c||"";var e=this.headers.clone();d&&NKa(d,function(f,h){e.set(h,f)});
d=g.bb(e.Ch(),DLa);c=g.A.FormData&&a instanceof g.A.FormData;!g.fb(ENa,b)||d||c||e.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");e.forEach(function(f,h){this.i.setRequestHeader(h,f)},this);
this.La&&(this.i.responseType=this.La);"withCredentials"in this.i&&this.i.withCredentials!==this.Ea&&(this.i.withCredentials=this.Ea);try{ILa(this),0<this.J&&(this.Y=CLa(this.i),f5(V5(this,"Will abort after "+this.J+"ms if incomplete, xhr2 "+this.Y)),this.Y?(this.i.timeout=this.J,this.i.ontimeout=(0,g.C)(this.QD,this)):this.X=g.Jm(this.QD,this.J,this)),f5(V5(this,"Sending request")),this.L=!0,this.i.send(a),this.L=!1}catch(f){f5(V5(this,"Send error: "+f.message)),FLa(this,f)}};
...
g.k.XH=function(){this.Ga()||(this.Ba||this.L||this.C?HLa(this):this.CQ())};
g.k.CQ=function(){HLa(this)};
...
g.k.getLastError=function(){return"string"===typeof this.u?this.u:String(this.u)};g.k=JLa.prototype;g.k.Jy=null;g.k.Lg=null;g.k.Ww=!1;g.k.dJ=null;g.k.ev=null;g.k.VA=null;g.k.Ky=null;g.k.eb=null;g.k.gk=-1;g.k.vr=null;g.k.Gr=null;g.k.connect=function(a){this.Ky=a;a=X5(this.i,null,this.Ky);G5(3);this.dJ=Date.now();var b=this.i.J;null!=b?(this.vr=b[0],(this.Gr=b[1])?(this.eb=1,KLa(this)):(this.eb=2,Z5(this))):(d5(a,"MODE","init"),this.Lg=new I5(this,void 0,void 0,void 0),this.Lg.Wm=this.Jy,J5(this.Lg,a,!1,null,!0),this.eb=0)};
...
g.k.Cu=function(){this.gk=this.Lg.rr;if(this.Lg.Si)0==this.eb?this.Gr?(this.eb=1,KLa(this)):(this.eb=2,Z5(this)):2==this.eb&&((!g.xe||g.be(10)?!this.Ww:200>this.VA-this.ev)?(G5(11),Y5(this.i,this,!1)):(G5(12),Y5(this.i,this,!0)));else{0==this.eb?G5(9):2==this.eb&&G5(10);var a=this.i;this.Lg.getLastError();a.rj=this.gk;f6(a,2)}};
g.k.Kt=function(){return this.i.Kt()};
g.k.isActive=function(){return this.i.isActive()};
g.k.Hi=function(a){this.i.Hi(a)};g.k=$5.prototype;g.k.qj=null;g.k.Vr=null;g.k.xg=null;g.k.Ud=null;g.k.Ly=null;g.k.fv=null;g.k.SE=null;g.k.Du=null;g.k.Us=0;g.k.zO=0;g.k.xf=null;g.k.Pl=null;g.k.wk=null;g.k.Mn=null;g.k.Hl=null;g.k.Jx=null;g.k.mq=-1;g.k.LG=-1;g.k.rj=-1;g.k.Tp=0;g.k.Ip=0;g.k.Fn=8;g.Ta(MLa,g.Fl);g.Ta(NLa,g.Fl);g.k=$5.prototype;g.k.connect=function(a,b,c,d,e){G5(0);this.Ly=b;this.Vr=c||{};d&&void 0!==e&&(this.Vr.OSID=d,this.Vr.OAID=e);this.C?(E5((0,g.C)(this.jF,this,a),100),RLa(this)):this.jF(a)};
g.k.jF=function(a){this.Hl=new JLa(this);this.Hl.Jy=this.qj;this.Hl.l=this.B;this.Hl.connect(a)};
g.k.RD=function(){return 0==this.eb};
g.k.getState=function(){return this.eb};
g.k.fI=function(a){this.Pl=null;VLa(this,a)};
g.k.eI=function(){this.wk=null;this.Ud=new I5(this,this.l,"rpc",this.G);this.Ud.Wm=this.qj;this.Ud.Iy=0;var a=this.SE.clone();b5(a,"RID","rpc");b5(a,"SID",this.l);b5(a,"CI",this.Jx?"0":"1");b5(a,"AID",this.mq);a6(this,a);if(!g.xe||g.be(10))b5(a,"TYPE","xmlhttp"),J5(this.Ud,a,!0,this.Du,!1);else{b5(a,"TYPE","html");var b=this.Ud,c=!!this.Du;b.Lq=3;b.Cl=c5(a.clone());yLa(b,c)}};
g.k.aI=function(a,b){if(0!=this.eb&&(this.Ud==a||this.xg==a))if(this.rj=a.rr,this.xg==a&&3==this.eb)if(7<this.Fn){try{var c=this.B.parse(b)}catch(d){c=null}if(Array.isArray(c)&&3==c.length)if(a=c,0==a[0])a:{if(!this.wk){if(this.Ud)if(this.Ud.Cq+3E3<this.xg.Cq)c6(this),this.Ud.cancel(),this.Ud=null;else break a;e6(this);G5(19)}}else this.LG=a[1],0<this.LG-this.mq&&37500>a[2]&&this.Jx&&0==this.Ip&&!this.Mn&&(this.Mn=E5((0,g.C)(this.bP,this),6E3));else f6(this,11)}else b!=DNa.zW.i&&f6(this,11);else if(this.Ud==
a&&c6(this),!g.oc(b))for(a=this.B.parse(b),b=0;b<a.length;b++)c=a[b],this.mq=c[0],c=c[1],2==this.eb?"c"==c[0]?(this.l=c[1],this.Du=c[2],c=c[3],null!=c?this.Fn=c:this.Fn=6,this.eb=3,this.xf&&this.xf.fF(),this.SE=X5(this,this.Kt()?this.Du:null,this.Ly),WLa(this)):"stop"==c[0]&&f6(this,7):3==this.eb&&("stop"==c[0]?f6(this,7):"noop"!=c[0]&&this.xf&&this.xf.eF(c),this.Ip=0)};
g.k.bP=function(){null!=this.Mn&&(this.Mn=null,this.Ud.cancel(),this.Ud=null,e6(this),G5(20))};
g.k.Cu=function(a){if(this.Ud==a){c6(this);this.Ud=null;var b=2}else if(this.xg==a)this.xg=null,b=1;else return;this.rj=a.rr;if(0!=this.eb)if(a.Si)1==b?(b=F5,b.dispatchEvent(new MLa(b,a.Mo?a.Mo.length:0,Date.now()-a.Cq,this.Tp)),b6(this),this.u.length=0):WLa(this);else{var c=a.getLastError(),d;if(!(d=3==c||7==c||0==c&&0<this.rj)){if(d=1==b)this.xg||this.Pl||1==this.eb||2<=this.Tp?d=!1:(this.Pl=E5((0,g.C)(this.fI,this,a),XLa(this,this.Tp)),this.Tp++,d=!0);d=!(d||2==b&&e6(this))}if(d)switch(c){case 1:f6(this,
...
g.k.AS=function(a){a?G5(2):(G5(1),YLa(this,8))};
...
g.k.Hi=function(a){var b=F5;b.dispatchEvent(new NLa(b,a))};
g.k.Kt=function(){return!(!g.xe||g.be(10))};
g.k=ZLa.prototype;g.k.fF=function(){};
g.k.eF=function(){};
g.k.dF=function(){};
g.k.vz=function(){};
g.k.MF=function(){return{}};
g.k.isActive=function(){return!0};g.k=$La.prototype;g.k.isEmpty=function(){return g.gb(this.i)&&g.gb(this.l)};
...
g.k.isActive=function(){return this.i.isActive()};
g.k.reset=function(){this.i.stop();this.Ef=5E3};g.Ta(h6,ZLa);g.k=h6.prototype;g.k.subscribe=function(a,b,c){return this.u.subscribe(a,b,c)};
...
g.k.dispose=function(){this.X||(this.X=!0,g.Di(this.u),cMa(this),g.Di(this.l),this.l=null,this.Y=function(){return""})};
g.k.Ga=function(){return this.X};
g.k.connect=function(a,b,c){if(!this.i||2!=this.i.getState()){this.V="";this.l.stop();this.C=a||null;this.B=b||0;a=this.ma+"/test";b=this.ma+"/bind";var d=new $5(c?c.firstTestResults:null,c?c.secondTestResults:null,this.ra),e=this.i;e&&(e.xf=null);d.xf=this;this.i=d;i6(this);if(this.i){d=g.M("ID_TOKEN");var f=this.i.qj||{};d?f["x-youtube-identity-token"]=d:delete f["x-youtube-identity-token"];this.i.qj=f}e?(3!=e.getState()&&0==TLa(e)||e.getState(),this.i.connect(a,b,this.G,e.l,e.mq)):c?this.i.connect(a,
b,this.G,c.sessionId,c.arrayId):this.i.connect(a,b,this.G)}};
g.k.sendMessage=function(a,b){a={_sc:a};b&&g.Vb(a,b);this.l.isActive()||2==(this.i?this.i.getState():0)?this.J.push(a):j6(this)&&(i6(this),SLa(this.i,a))};
g.k.fF=function(){this.l.reset();this.C=null;this.B=0;if(this.J.length){var a=this.J;this.J=[];for(var b=0,c=a.length;b<c;++b)SLa(this.i,a[b])}this.W("handlerOpened")};
...
g.k.eF=function(a){"S"==a[0]?this.V=a[1]:"gracefulReconnect"==a[0]?(this.l.start(),QLa(this.i)):this.W("handlerMessage",new aMa(a[0],a[1]))};
...
g.k.hS=function(){this.l.isActive();0==TLa(this.i)&&this.connect(this.C,this.B)};k6.prototype.B=function(a,b,c,d){b?a(d):a({text:c.responseText})};
k6.prototype.u=function(a,b){a(Error("Request error: "+b.status))};
k6.prototype.C=function(a){a(Error("request timed out"))};var jMa=Date.now(),n6=null,q6=Array(50),p6=-1,r6=!1;g.Ta(s6,g.O);s6.prototype.Xg=function(){return this.screens};
...
g.k.ML=function(a){this.i=null;a.status&&404==a.status?this.l>=FNa.length?this.W("pairingFailed",Error("DIAL polling timed out")):(a=FNa[this.l],this.yb=g.np((0,g.C)(this.oI,this),a),this.l++):this.W("pairingFailed",Error("Server error "+a.status))};
g.k.OL=function(){this.i=null;this.W("pairingFailed",Error("Server not responding"))};
var FNa=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g.Ta(v6,s6);g.k=v6.prototype;g.k.start=function(){u6(this)&&this.W("screenChange");!g.qv("yt-remote-lounge-token-expiration")&&nMa(this);g.pp(this.i);this.i=g.np((0,g.C)(this.start,this),1E4)};
g.k.add=function(a,b){u6(this);kMa(this,a);w6(this,!1);this.W("screenChange");b(a);a.token||nMa(this)};
g.k.remove=function(a,b){var c=u6(this);mMa(this,a)&&(w6(this,!1),c=!0);b(a);c&&this.W("screenChange")};
...
g.k.RB=function(){g.pp(this.u);this.u=NaN;this.l&&this.l.abort();var a=pMa(this);if(e5(a)){var b=l6(this.C,"/pairing/get_screen_availability");this.l=m6(this.C,b,{lounge_token:g.Jb(a).join(",")},(0,g.C)(this.WQ,this,a),(0,g.C)(this.VQ,this))}else A6(this,{}),B6(this)};
g.k.WQ=function(a,b){this.l=null;var c=g.Jb(pMa(this));if(g.xb(c,g.Jb(a))){b=b.screens||[];c={};for(var d=0,e=b.length;d<e;++d)c[a[b[d].loungeToken]]="online"==b[d].status;A6(this,c);B6(this)}else this.Gd("Changing Screen set during request."),this.RB()};
...
g.k.PL=function(a,b,c,d){g.up(l6(this.B,"/pairing/get_screen"),{method:"POST",postParams:{pairing_code:a},timeout:5E3,onSuccess:(0,g.C)(function(e,f){e=new i5(f.screen||{});if(!e.name||tMa(this,e.name)){a:{f=e.name;for(var h=2,l=b(f,h);tMa(this,l);){h++;if(20<h)break a;l=b(f,h)}f=l}e.name=f}c(D6(this,e))},this),
...
g.k.DN=function(){vMa(this);this.W("screenChange");this.i.update()};
...
g.k.va=function(){this.bC("");F6.Fd.va.call(this)};g.v(I6,F6);g.k=I6.prototype;g.k.aC=function(a){if(this.l){if(this.l==a)return;H6(this,"Overriding cast session with new session object");EMa(this);this.ma=!1;this.V="unknown";this.l.removeUpdateListener(this.Y);this.l.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.ra)}this.l=a;this.l.addUpdateListener(this.Y);this.l.addMessageListener("urn:x-cast:com.google.youtube.mdx",this.ra);AMa(this,"getMdxSessionStatus")};
...
g.k.bC=function(){};
g.k.va=function(){this.info("disposeInternal");EMa(this);this.l&&(this.l.removeUpdateListener(this.Y),this.l.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.ra));this.l=null;F6.prototype.va.call(this)};
g.k.HR=function(a,b){if(!this.Ga())if(b)if(b=C5(b),g.Ma(b))switch(a=""+b.type,b=b.data||{},this.info("onYoutubeMessage_: "+a+" "+g.Aj(b)),a){case "mdxSessionStatus":yMa(this,b);break;case "loungeToken":BMa(this,b);break;default:H6(this,"Unknown youtube message: "+a)}else H6(this,"Unable to parse message.");else H6(this,"No data in message.")};
g.k.bG=function(a,b,c,d){g.pp(this.L);this.L=0;sMa(this.u,this.i.label,a,this.i.friendlyName,(0,g.C)(function(e){e?b(e):0<=d?(H6(this,"Screen "+a+" appears to be offline. "+d+" retries left."),this.L=g.np((0,g.C)(this.bG,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
...
g.k.stop=function(){LMa(this);this.l?this.l.stop((0,g.C)(this.ag,this,null),(0,g.C)(this.ag,this,"Failed to stop DIAL device.")):this.ag()};
g.k.va=function(){LMa(this);this.l&&this.l.removeUpdateListener(this.Ba);this.l=null;F6.prototype.va.call(this)};
...
(chrome.cast.addReceiverActionListener(this.G),gMa(),this.l.subscribe("onlineScreenChange",(0,g.C)(this.VD,this)),this.u=NMa(this),chrome.cast.setCustomReceivers(this.u,g.Ia,(0,g.C)(function(f){this.Gd("Failed to set initial custom receivers: "+g.Aj(f))},this)),this.W("yt-remote-cast2-availability-change",S6(this)),b(!0))},this),(0,g.C)(function(f){this.Gd("Failed to initialize API: "+g.Aj(f));
b(!1)},this))};
g.k.mS=function(a,b){R6("Setting connected screen ID: "+a+" -> "+b);if(this.i){var c=this.i.getScreen();if(!a||c&&c.id!=a)R6("Unsetting old screen status: "+this.i.i.friendlyName),T6(this,null)}if(a&&b){if(!this.i){c=o5(this.l.Xg(),a);if(!c){R6("setConnectedScreenStatus: Unknown screen.");return}if("shortLived"==c.idType){R6("setConnectedScreenStatus: Screen with id type to be short lived.");return}a=MMa(this,c);a||(R6("setConnectedScreenStatus: Connected receiver not custom..."),a=new chrome.cast.Receiver(c.uuid?
...
g.k.va=function(){this.l.unsubscribe("onlineScreenChange",(0,g.C)(this.VD,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.G);var a=dMa,b=g.Ha("yt.mdx.remote.debug.handlers_");g.kb(b||[],a);g.Di(this.i);g.O.prototype.va.call(this)};
...
this.W("yt-remote-cast2-session-change",this.i.getScreen()),Promise.resolve(new chrome.cast.DialLaunchResponse(!1));this.Gd('Changing CAST intent from "'+c.receiverType+'" to "dial" for '+b.friendlyName);T6(this,new L6(this.l,b,this.C,this.B))}b=this.i;b.L=a;b.L.appState==chrome.cast.DialAppState.RUNNING?(a=b.L.extraData||{},c=a.screenId||null,M6(b)&&a.loungeToken?a.loungeTokenRefreshIntervalMs?a=IMa(b,{name:b.i.friendlyName,screenId:a.screenId,loungeToken:a.loungeToken,dialId:b.L.receiver.label,
screenIdType:"shortLived"},a.loungeTokenRefreshIntervalMs):(g.To(Error("No loungeTokenRefreshIntervalMs presents in additionalData: "+JSON.stringify(a)+".")),a=JMa(b,c)):a=JMa(b,c)):a=O6(b);return a};
...
g.k.VD=function(){this.Ga()||(this.u=NMa(this),R6("Updating custom receivers: "+g.Aj(this.u)),chrome.cast.setCustomReceivers(this.u,g.Ia,(0,g.C)(function(){this.Gd("Failed to set custom receivers.")},this)),this.W("yt-remote-cast2-availability-change",S6(this)))};
...
g.k.va=function(){ZMa(this);this.u=null;this.B.clear();k7(this,null);g.O.prototype.va.call(this)};
...
g.k.Xs=function(a){o6("CP","Cast media: "+!!a);this.i&&this.i.removeUpdateListener(this.J);if(this.i=a)this.i.addUpdateListener(this.J),$Ma(this),this.W("remotePlayerChange")};
g.k.gP=function(a){a?($Ma(this),this.W("remotePlayerChange")):this.Xs(null)};
g.k.vC=function(){r7(this,"sendDebugCommand",{debugCommand:"stats4nerds "})};
g.k.oP=function(){var a=WMa();a&&k7(this,a)};
...
params:g.Aj(l)},a,ZKa())}else u7("Connecting without params"),this.i.connect({},a,ZKa());bNa(this)};
...
eNa(this,a);break;case "loungeScreenDisconnected":g.lb(this.l,function(c){return"LOUNGE_SCREEN"==c.type});
eNa(this,!1);break;case "remoteConnected":var b=new h5(C5(a.params.device));g.bb(this.l,function(c){return b?c.id==b.id:!1})||JKa(this.l,b);
break;case "remoteDisconnected":b=new h5(C5(a.params.device));g.lb(this.l,function(c){return b?c.id==b.id:!1});
break;case "gracefulDisconnect":break;case "playlistModified":gNa(this,a);break;case "nowPlaying":iNa(this,a);break;case "onStateChange":hNa(this,a);break;case "onAdStateChange":jNa(this,a);break;case "onVolumeChanged":kNa(this,a);break;case "onSubtitlesTrackChanged":fNa(this,a);break;case "nowAutoplaying":lNa(this,a);break;case "autoplayDismissed":this.W("autoplayDismissed");break;case "autoplayUpNext":this.G=a.params.videoId||null;this.W("autoplayUpNext",this.G);break;case "onAutoplayModeChanged":this.B=
a.params.autoplayMode;this.W("autoplayModeChange",this.B);"DISABLED"==this.B&&this.W("autoplayDismissed");break;case "onHasPreviousNextChanged":mNa(this,a);break;case "requestAssistedSignIn":this.W("assistedSignInRequested",a.params.authCode);break;default:u7("Unrecognized action: "+a.action)}};
...
g.k.Pp=function(a){u7("Disconnecting with "+a);w7(this);this.W("beforeDisconnect",a);1==a&&t5();cMa(this.i,a);this.dispose()};
...
g.k.lS=function(a,b){z7(this,a,b);dNa(this)};
...
g.k.RP=function(){g.Ob(this.B)||xNa(this,this.B);this.C=!1};
...
break;case -1:this.Hb(new g.yJ(64));break;case -1E3:this.Hb(new g.yJ(128,{errorCode:"mdx.remoteerror",errorMessage:"Video n\u00e0y kh\u00f4ng kh\u1ea3 d\u1ee5ng \u0111\u1ec3 ph\u00e1t l\u1ea1i t\u1eeb xa."}))}a=m7(this.Ob).trackData;var b=this.B;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.kind==b.kind:1)||(this.B=a,xNa(this,a));a=m7(this.Ob);-1===a.volume||Math.round(this.I.getVolume())===a.volume&&this.I.isMuted()===a.muted||this.V.isActive()||
this.CJ()}else wNa(this)};
g.k.WH=function(){this.I.W("mdxpreviousnextchange")};
g.k.Nw=function(){V7(this)||wNa(this)};
...
g.k.CJ=function(){var a=this;if(V7(this)){var b=m7(this.Ob);this.events.dc(this.X);b.muted?this.I.mute():this.I.unMute();this.I.setVolume(b.volume);this.X=this.events.N(this.I,"onVolumeChange",function(c){vNa(a,c)})}};
...
g.k.Hb=function(a){this.u.stop();var b=this.G;if(!g.DJ(b,a)){var c=g.U(a,2);c!==g.U(this.G,2)&&this.I.Qo(c);this.G=a;zNa(this.l,b,a)}};g.v(Y7,g.V);Y7.prototype.Oc=function(){this.i.show()};
...
g.k.load=function(){this.player.cancelPlayback();g.DM.prototype.load.call(this);this.qh=new U7(this,this.player,this.Ob);var a=(a=uNa())?a.currentTime:0;var b=R7()?new l7(L7(),void 0):null;0==a&&b&&(a=h7(m7(b)));0!==a&&this.Sb(a);zNa(this,this.Xc,this.Xc);this.player.Vj(6)};
...
g.k.YH=function(){var a=[this.Ei],b=a.concat,c=rNa();$6()&&g.qv("yt-remote-cast-available")&&c.push({key:"cast-selector-receiver",name:"Cast..."});this.Dm=b.call(a,c);a=M7()||this.Ei;d8(this,a);this.player.Ma("onMdxReceiversChange")};
